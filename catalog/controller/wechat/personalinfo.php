       ...
       // $data['header'] = $this->load->controller('common/wechatheader');
        ...
        if($data['isnotregist'] == "1"){
            ...
            $response = array(
                ...
                'data' =>array(
                    'url' => "https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx5ce715491b2cf046&redirect_uri=http://test.jinxingjk.com/wechat/edituser&response_type=code&scope=snsapi_userinfo&state=STATE#wechat_redirect",
                ),
            );
