...
class ControllerProductProduct extends Controller
{
    ...
    public function index()
    {
		...
		$id = $this->request->json("id", 1);

        $log->write("Enter in ControllerProductProduct ". $id);
...
*/
        ...
        for ($i=0;$i<count($product_info['images']);$i++){

            $product_info['images'][$i]['image']= "image/" .$product_info['images'][$i]['image'];

        }
        $product_info['price'] = floatval($product_info['price']);
        ...
        $product_info['service_tel'] = WECHAT_SERVICE_TEL;
